...
// LoaderIcon is a functional component that takes in two props: fill and className
const LoaderIcon = ({ fill, className }) => (
  <svg
    // className is set to "Loader--" and the value of the fill prop, and className prop
    className={`Loader--${fill} ${className}`}
    // aria-hidden, focusable, and role attributes are used for accessibility 
    aria-hidden="true"
    focusable="false"
    role="presentation"
    // viewBox, width, height, version, and xmlns are used to set properties of the SVG
  ...
  >
    {/* path element defines the shape of the SVG*/}
